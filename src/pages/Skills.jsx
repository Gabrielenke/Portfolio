  ...
  return (
    <section className=" flex min-h-screen pb-32   text-dark dark:text-light">
      <div className="flex flex-col md:ml-32 md:mt-32 md:w-[40vw]  md:gap-5">
        ...
        <section className="mx-auto mt-10 flex max-w-[80vw] flex-wrap items-center justify-around gap-10 md:mx-0 md:mt-0 md:w-auto  md:items-start md:justify-start  md:gap-28">
